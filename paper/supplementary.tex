% =====================================================================
% Standalone Technical Appendix -- the ALTERNATIVE to binding the appendix
% into main.tex.
%
% The arXiv preprint does NOT use this file: main.tex sets
% \includeappendixtrue and \input{supplementary_appendix} directly, so the
% whole paper is one PDF. Use this wrapper only for a page-limited venue
% where the appendix must be a separate upload -- and set
% \includeappendixfalse in main.tex first, or the content appears twice.
%
