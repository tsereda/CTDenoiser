...
label-free regime and finds the transport not merely optional but harmful
...
(Table~\ref{tab:sim-ldct}) and on a second \emph{anatomy} (chest,
Table~\ref{tab:chest}), so neither is tied to a single acquisition, noise model,
or anatomy.  Broader multi-scanner and multi-anatomy replication is the natural
