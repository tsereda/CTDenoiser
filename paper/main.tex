...
$\sim$4\,dB PSNR \emph{erode} lesion detectability by $7$--$8\%$ ($d'$ at
...
Table~\ref{tab:sweep-benchmark} (the three CNN architectures; CTformer
detectability is still landing) and report the mean over architectures and
seeds.  The
...
\begin{table*}[t]
  ...
  \caption{Task-based detectability on the completed benchmark models
           ...
           $\times$ $3$ seeds ($27$ runs; CTformer detectability is still
           landing).  \emph{Top:} CHO detectability index $d'$ for the noisy
