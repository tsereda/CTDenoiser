...
% TODO(arXiv): fill in Jha's first name (and middle initial, if used) and
% confirm the affiliation line before uploading.
\author{
    Tim Sereda\textsuperscript{1},
    \textbf{??}~Jha\textsuperscript{1}
}
\affiliations{
...
distrust (qualitative comparison, technical appendix).  \textbf{Fourth},
...
against the direct regressor at matched pairing (technical appendix).
...
Swapping the estimator on the same pairs (technical appendix)
...
(technical appendix).  Both predictions reproduce.  \emph{(i)} One-step
...
the flow or the pairing is what matters---is in the technical appendix.
