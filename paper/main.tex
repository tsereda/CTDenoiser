...
not iterative sampling, is what helps.  Finally, a task-based evaluation with
...
Noise2Sim (Section~\ref{sec:results}); (iii) a proposed self-supervised
rectified flow that targets the remaining gap (Section~\ref{sec:method}); and
...
Table~\ref{tab:detect} shows three things.  \textbf{First}, the detectability
...
radiologists distrust.  Reporting the \emph{preserved} ratio
