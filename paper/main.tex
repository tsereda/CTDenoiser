...
\begin{table*}[t]
  ...
  \caption{\textbf{Main benchmark sweep} (\texttt{sweep.yml}): architecture
           ...
           variant).  The three CNN backbones (RED-CNN, U-Net, DnCNN) are
           complete over $3$ seeds and reported as mean\,$\pm$\,s.d.; the
           CTformer runs are still training and CFM is pending (``---'').  The
  ...
  \begin{tabular}{llrccccc}
    ...
    CTformer~\cite{wang2022ctformer} & Supervised & $0.40\mathrm{M}$ & \emph{training} & --- & --- & --- & --- \\
    ...
    CTformer~\cite{wang2022ctformer} & Noise2Sim~\cite{niu2020noise2sim} & $0.40\mathrm{M}$ & \emph{training} & --- & --- & --- & --- \\
    \midrule
    ...
    CTformer~\cite{wang2022ctformer} & Noise2Void~\cite{krull2019noise2void} & $0.40\mathrm{M}$ & \emph{training} & --- & --- & --- & --- \\
    \bottomrule
  \end{tabular}
\end{table*}
