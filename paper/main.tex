...
\begin{figure*}[t]
  ...
  \IfFileExists{figures/qualitative.pdf}{%
    ...
    \fbox{\parbox{0.97\textwidth}{\centering\vspace{2.2em}\emph{figures/qualitative.pdf}\\[2pt]
      generate with \texttt{python scripts/figure\_qualitative.py {-}{-}h5 <cache> {-}{-}patient <id> {-}{-}slice <n> {-}{-}models ...}\vspace{2.2em}}}}
...
\begin{figure*}[t]
  \centering
  \IfFileExists{figures/steps_departure.pdf}{%
    \includegraphics[width=\textwidth]{figures/steps_departure.pdf}}{%
    \fbox{\parbox{0.97\textwidth}{\centering\vspace{2.2em}\emph{figures/steps\_departure.pdf}\\[2pt]
      generate with \texttt{python scripts/figure\_steps.py <hallucination\_export.csv> {-}{-}regression-ref 1.99}\vspace{2.2em}}}}
  \caption{\textbf{The finite-step departure, predicted and confirmed.}
           ...
           regression baseline (dashed), which one-step flow ties.}
  \label{fig:steps}
\end{figure*}
